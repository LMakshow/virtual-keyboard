const keyData = [
  [ // row 1
    ...
    { key: '2', shift: { ru: '"', en: '@' }, code: 'Digit2' },
    { key: '3', shift: { ru: '№', en: '#' }, code: 'Digit3' },
    { key: '4', shift: { ru: ';', en: '$' }, code: 'Digit4' },
    { key: '5', shift: '%', code: 'Digit5' },
    { key: '6', shift: { ru: ':', en: '^' }, code: 'Digit6' },
    { key: '7', shift: { ru: '?', en: '&' }, code: 'Digit7' },
  ...
  [ // row 2
    ...
    {
      key: '\\', shift: '/', code: 'Backslash', class: 'key_backslash',
    },
  ],
  [ // row 3
    {
      key: 'Caps<br>Lock', code: 'CapsLock', class: 'key_capslock', noType: true,
    },
